...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "Zombroom", "Extreme knockback but reduced damage and lengthened swing delay, becomes a knockback tool", function(wept)
    wept.Primary.Delay = wept.Primary.Delay * 1.5
    wept.MeleeDamage = wept.MeleeDamage * 0.5
    wept.MeleeKnockBack = 500
end)
