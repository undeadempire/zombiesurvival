...
--The Owner is not the entity 'orphic' and pl.Orphic = true or gets the Iron sights nad 0.9 or 1.1
	local orphic = not owner.Orphic and 1 or self:GetIronsights() and 0.9 or 1.1 -- Only the first number really matter too much from hwat I can tell
...
--Last thing that applies all th ewierd stuff
