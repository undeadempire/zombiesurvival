...
SWEP.PrintName = "Woodframe Warehouse"
SWEP.Description = "100 boards with standard woodframe pack. Good cading and building material."
...
SWEP.JunkModels = {
	Model("models/props_phx/construct/wood/wood_wire1x1.mdl"),
	...
	Model("models/props_phx/construct/wood/wood_wire1x1x2.mdl"),
