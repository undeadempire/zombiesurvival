...
GM:AddSkill(SKILL_D_HEMOPHILIA, "Debuff: Hemophilia", GOOD.."+15 starting Worth\n"..BAD.."Bleed for 25% extra damage when hit",
																4,			2,					{}, TREE_HEALTHTREE)
...
GM:AddSkill(SKILL_REGENERATOR, "Regenerator", GOOD.."Regenerate 1 health every 5s up to 75% max HP\n"..BAD.."-50% maximum blood armor",
																-5,			-2,					{}, TREE_HEALTHTREE)
...
GM:AddSkill(SKILL_SPEED4, "Speed IV", GOOD.."+3 movement speed\n"..BAD.."-3 health",
																-4,			0,					{SKILL_SPEED5, SKILL_SAFEFALL}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_SPEED5, "Speed V", GOOD.."+4 movement speed\n"..BAD.."-4 health",
...
GM:AddSkill(SKILL_U_CORRUPTEDFRAGMENT, "Unlock: Corrupted Fragment", GOOD.."Unlocks purchasing the Corrupted Fragment\nGoes to corrupted sigils instead",
																-2,			2,					{}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_ULTRANIMBLE, "Ultra Nimble", GOOD.."+7.5 movement speed\n"..BAD.."-12 health\n"..BAD.."-8 maximum blood armor\n",
																0,			-6,					{}, TREE_SPEEDTREE)
...
GM:AddSkill(SKILL_CONEFFECT, "Concentrated Effect", GOOD.."+5% explosive damage",
																2,			-5,					{}, TREE_GUNTREE)
GM:AddSkill(SKILL_TRUEWOOISM, "Wooism", GOOD.."No aim spreading for moving or jumping\n"..BAD.."No aim tightening for standing still or crouching",
																7,			0,					{}, TREE_GUNTREE)
...
--------------SPEED 4------------------
GM:AddSkillModifier(SKILL_SPEED4, SKILLMOD_SPEED, 3)            
GM:AddSkillModifier(SKILL_SPEED4, SKILLMOD_HEALTH, -3)
--------------SPEED 5------------------
GM:AddSkillModifier(SKILL_SPEED5, SKILLMOD_SPEED, 4)
GM:AddSkillModifier(SKILL_SPEED5, SKILLMOD_HEALTH, -4)
---------------------------MOTION-----------------------------------------------------------
...
---------------------------MISC. MOVEMENT----------------------------------------------------
---------SAFE FALL---------------------
GM:AddSkillModifier(SKILL_SAFEFALL, SKILLMOD_FALLDAMAGE_DAMAGE_MUL, -0.6)
...
---------HEMOPHILIA-------------------
GM:AddSkillModifier(SKILL_D_HEMOPHILIA, SKILLMOD_WORTH, 15)
...
-------------ULTRA-NIMBLE--------------
GM:AddSkillModifier(SKILL_ULTRANIMBLE, SKILLMOD_SPEED, 7.5)
GM:AddSkillModifier(SKILL_ULTRANIMBLE, SKILLMOD_HEALTH, -12)
GM:AddSkillModifier(SKILL_ULTRANIMBLE, SKILLMOD_BLOODARMOR, -8.0)
-------------EGOCENTRIC----------------
...
GM:AddSkillModifier(SKILL_BLASTPROOF, SKILLMOD_HEALTH, -15)
...
GM:AddSkillModifier(SKILL_SANGUINE, SKILLMOD_HEALTH, -6)

GM:AddSkillModifier(SKILL_ANTIGEN, SKILLMOD_BLOODARMOR_DMG_REDUCTION, 0.05)
GM:AddSkillModifier(SKILL_ANTIGEN, SKILLMOD_HEALTH, -6)
GM:AddSkillModifier(SKILL_ANTIGEN, SKILLMOD_FOODEATTIME_MUL, 1.1)
...
GM:AddSkillModifier(SKILL_LEVELHEADED, SKILLMOD_AIMSPREAD_MUL, 0.03)
