...
{
	Color = Color(255, 255, 53),
	Name = "FERVOR!",
	ValFunc = statusValueFunction("fervor"),
	Max = 14,
	Icon = Material("zombiesurvival/statuses/fervor.png")
},
{
	Color = Color(179, 0, 0),
	Name = "FATIGUE!",
	ValFunc = statusValueFunction("fatigue"),
	Max = 10,
	Icon = Material("zombiesurvival/statuses/fervor.png")
},
{
	Color = Color(255, 119, 51),
	Name = "BURNING!",
	ValFunc = statusValueFunction("burn"),
	Max = 10,
	Icon = Material("zombiesurvival/statuses/burn.png")
},
}
