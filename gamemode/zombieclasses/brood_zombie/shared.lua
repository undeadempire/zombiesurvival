CLASS.Name = "Brood Zombie"
CLASS.TranslationName = "class_brood_zombie"
CLASS.Description = "description_brood_zombie"
CLASS.Help = "controls_zombie_brood"
...
CLASS.SWEP = "weapon_zs_broodzombie"
