...
GM:AddWeaponBreakdownRecipe("weapon_zs_electrohammer",						"comp_poweredelebattery")
GM:AddWeaponBreakdownRecipe("weapon_zs_stubber",							"comp_modbarrel")
GM:AddWeaponBreakdownRecipe("weapon_zs_peashooter",							"comp_modbarrel")
...
GM:AddWeaponBreakdownRecipe("weapon_zs_sawedoff",							"comp_dbarrel")

-- Assemblies (Assembly, Component, Weapon)
GM.Assemblies["weapon_zs_waraxe"] 								= {"comp_modbarrel", 		"weapon_zs_glock3"}
GM.Assemblies["weapon_zs_electrosledge"] 						= {"comp_poweredelebattery", 	"weapon_zs_sledgehammer"}
...
GM.Assemblies["weapon_zs_bastion"] 								= {"trinket_ammovestiii",	"weapon_zs_barrage"}
...
GM.Assemblies["weapon_zs_jurisdiction"]							= {"comp_dbarrel",			"weapon_zs_ender"}
...
GM:AddInventoryItemData("comp_poweredelebattery",		"Powered Electrobattery",		"A charged electrobattery. Could be used to improve repairing motions, though is too big to fit on a regular hammer",	"models/Items/combine_rifle_cartridge01.mdl")
...
GM:AddInventoryItemData("comp_dbarrel",			"Double Barrel",			"Twin barrels stripped off of a shotgun. Could be used to add double barrel action to another shotgun.",	"models/Items/combine_rifle_cartridge01.mdl")
...
GM:AddSkillModifier(trinket, SKILLMOD_KNOCKDOWN_RECOVERY_MUL, -0.35)
...
GM:AddSkillModifier(trinket, SKILLMOD_JUMPPOWER_MUL, 0.20)

-- Starter Trinkets


trinket = GM:AddTrinket("Starkherzig", "stark", false, hpveles, hpweles, 4, "+500 maximum health\n-50% jumppower \n-140 movespeed\n-50% phasing speed")
GM:AddSkillModifier(trinket, SKILLMOD_HEALTH, 500.00)
GM:AddSkillModifier(trinket, SKILLMOD_BARRICADE_PHASE_SPEED_MUL, -0.50)
GM:AddSkillModifier(trinket, SKILLMOD_SPEED, -140.00)
GM:AddSkillModifier(trinket, SKILLMOD_JUMPPOWER_MUL, -0.50)

trinket = GM:AddTrinket("Darkstalker", "dstalker", false, hpveles, hpweles, 4, "+50 movespeed\n+50% reload speed \n+50% hammerswing speed\n+100% unarmed damage\n+50% unarmed melee speed\n-60 health")
GM:AddSkillModifier(trinket, SKILLMOD_HEALTH, -60.00)
GM:AddSkillModifier(trinket, SKILLMOD_HAMMER_SWING_DELAY_MUL, -0.50)
GM:AddSkillModifier(trinket, SKILLMOD_SPEED, 50.00)
GM:AddSkillModifier(trinket, SKILLMOD_UNARMED_DAMAGE_MUL, 2.00)
GM:AddSkillModifier(trinket, SKILLMOD_UNARMED_SWING_DELAY_MUL, -0.50)
GM:AddSkillModifier(trinket, SKILLMOD_RELOADSPEED_MUL, 0.95)

trinket, trinketwep = GM:AddTrinket("9 lives", "ixlives", false, hpveles, hpweles, 2, "+100 maximum health\n+50% healing received")
GM:AddSkillModifier(trinket, SKILLMOD_HEALTH, 100)
GM:AddSkillModifier(trinket, SKILLMOD_HEALING_RECEIVED, 0.50)
trinketwep.PermitDismantle = true
