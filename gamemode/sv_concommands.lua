...
concommand.Add("zs_pointsshopbuy", function(sender, command, arguments)
	...
	if usescrap and not (itemcat == ITEMCAT_TRINKETS or itemcat == ITEMCAT_AMMO) and not itemtab.NoScrapCraft then return end
	...
	if itemtab.IsNail and sender.FreeNails == 2 then
		cost = 0
	else
